...
class WJetsPlot : public TSelector {
 public :
  ...
  const float SINGLE_JET_PROBABILITY = 64.0/2049135.0;
 ...
 WJetsPlot(TTree * /*tree*/ =0) : fChain(0) { }
  virtual ~WJetsPlot() { }
  ...
  virtual float   CalculateProbability(size_t numJets);
  ...
  ClassDef(WJetsPlot,0);
};
#endif // #ifndef WJetsPlot_h

#ifdef WJetsPlot_cxx

void WJetsPlot::Init(TTree *tree)
{
